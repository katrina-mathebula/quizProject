            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-1-answers-A">A) Actor </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                        <label for="question-1-answers-B">B) Musician</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                        <label for="question-1-answers-C">C) Painter</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-A">A) Actor</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
                        <label for="question-2-answers-B">B) Reporter</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                        <label for="question-2-answers-C">C) Director</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-3-answers-A">A) Actor</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                        <label for="question-3-answers-B">B) Musician</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                        <label for="question-3-answers-C">C) Model</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-4-answers-A">A) Actor</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-B" value="B" />
                        <label for="question-4-answers-B">B) Painter</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
                        <label for="question-4-answers-C">C) Musician</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-5-answers-A">A) Musician</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                        <label for="question-5-answers-B">B) Athlete</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                        <label for="question-5-answers-C">C) Director</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-6-answers-A">A) Actor </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-6-answers" id="question-6-answers-B" value="B" />
                        <label for="question-6-answers-B">B) Dancer</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-6-answers" id="question-6-answers-C" value="C" />
                        <label for="question-6-answers-C">C) Musician</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-7-answers-A">A) Author </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                        <label for="question-7-answers-B">B) Athlete</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" />
                        <label for="question-7-answers-C">C) Actor</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-8-answers-A">A) Musician </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                        <label for="question-8-answers-B">B) Athlete</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                        <label for="question-8-answers-C">C) Director</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-9-answers-A">A) Model </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                        <label for="question-9-answers-B">B) Actor</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-9-answers-C" value="C" />
                        <label for="question-9-answers-C">C) Politician</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-9-answers-D" value="D" />
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-10-answers-A">A) Musician </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-10-answers-B" value="B" />
                        <label for="question-10-answers-B">B) Athlete</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-10-answers" id="question-10-answers-C" value="C" />
                        <label for="question-10-answers-C">C) Boxer</label>
                    </div>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-14-answers-B">B) Model</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-14-answers" id="question-14-answers-C" value="C" />
                        <label for="question-14-answers-C">C) Politician</label>
                    </div>
